...
L.layerGroup([allEarthquakes, tectonicPlateData, majorEarthquake]);

// 2. Add a reference to the tectonic plates group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Techtonic Plates": tectonicPlateData,
...
L.geoJson(data, {
// Turn feature into circlemarker
pointToLayer: function(feature, latlng) {
  console.log(data1);
...
//Add Earthquake layer to out map
